...
#chemin ='C:\Users\HP630\Downloads\Compressed\E-shoclothing2008.csv'
data = pd.read_csv('2E-shoclothing2008.csv', index_col=0, encoding = "ISO-8859-1")

#url = 'https://github.com/aissakadda/RTest-Project1/blob/main/E-shoclothing2008.csv'
...
print('score model',model.score(X, y)) # évaluation avec le coefficient de corrélation
